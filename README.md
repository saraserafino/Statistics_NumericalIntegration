...
This project was initially done together with Franzese, this is a new version where the main mistakes are fixed.  
...
The full request of this project can be found [here](https://github.com/pcafrica/advanced_programming_2023-2024/blob/main/homeworks/homework_02.md).
